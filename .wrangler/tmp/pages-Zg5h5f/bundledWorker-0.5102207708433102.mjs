...
// ../.wrangler/tmp/bundle-RJsB8e/checked-fetch.js
...
async function handleCreateProduct(request, env) {
  ...
  try {
    ...
    try {
      const processFeatures = /* @__PURE__ */ __name((features) => {
        if (!features) return "[]";
  ...
  try {
    ...
    try {
      const rawProducts = await env.DB.prepare(`
        ...
        ORDER BY sort_order ASC, created_at DESC
      `).all();
      const parseList = /* @__PURE__ */ __name((value, fallback = []) => {
...
// ../.wrangler/tmp/bundle-RJsB8e/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-RJsB8e/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.5102207708433102.mjs.map
