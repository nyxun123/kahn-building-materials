          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-gray-100 hover:bg-black flex items-center justify-center transition-all duration-300 group"
                title={t('social.tiktok')}
              >
                <svg className="w-5 h-5 fill-gray-700 group-hover:fill-white transition-colors" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-100 hover:bg-red-600 flex items-center justify-center transition-all duration-300 group"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-100 hover:bg-gradient-to-br hover:from-purple-600 hover:via-pink-600 hover:to-orange-500 flex items-center justify-center transition-all duration-300 group"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-100 hover:bg-blue-600 flex items-center justify-center transition-all duration-300 group"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-100 hover:bg-green-500 flex items-center justify-center transition-all duration-300 group"
              ...
              <div className="relative group">
                <div className="w-10 h-10 rounded-full bg-gray-100 hover:bg-green-600 flex items-center justify-center transition-all duration-300 cursor-pointer">
                  <svg className="w-5 h-5 fill-gray-700 group-hover:fill-white transition-colors" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
