...
const HERO_COPY: Record<SiteLanguage, {
  ...
  zh: {
    ...
    description: '浏览杭州卡恩针对俄罗斯、越南、泰国、印尼等市场的OEM代工、CMS大宗供应、私标包装和应用培训专属落地页，包含本地化物流方案、认证资料和常见问题解答。',
    contactCta: '预约顾问',
    viewCta: '查看全部落地页',
  },
  en: {
    ...
    description: 'Explore Hangzhou Karn\'s market-specific landing pages for OEM contract manufacturing, bulk CMS supply, private label packaging, and application training across Russia, Vietnam, Thailand, and Indonesia.',
  ...
  ru: {
    ...
    description: 'Специализированные посадочные страницы Hangzhou Karn для рынков России, Вьетнама, Таиланда и Индонезии: OEM-производство, оптовая поставка CMS, частная торговая марка и обучающие материалы.',
  ...
  vi: {
    ...
    description: 'Các trang đích thị thị trường chuyên biệt của Hangzhou Karn cho Nga, Việt Nam, Thái Lan và Indonesia: sản xuất OEM, cung cấp CMS số lượng lớn, thương hiệu riêng và đào tạo ứng dụng.',
  ...
  th: {
    ...
    description: 'หน้าลงจัดทุกตลาดเฉพาะเฉพาเฉพาะของ Hangzhou Karn สำหรับตลาดในรัสเซีย, เวียดนาม, ไทย และอินโดนีเซีย: ผลิต OEM, จำหนวด CMS, แบรนดเฉพาะ และอบรมการใช้ง',
  ...
  id: {
    ...
    description: 'Halaman solusi pasar spesifik dari Hangzhou Karn untuk Rusia, Vietnam, Thailand dan Indonesia: manufaktur OEM, pasok CMS bulk, merek dagang dan pelatihan aplikasi dengan data terstruktur.',
